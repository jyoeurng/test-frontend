...
$(".btn-see-more").on("click",function(){$("#menu a").each(function(){$(this).removeClass("active")});var e=$(this).data("target");$(e).addClass("active"),$(this).parents(".slide").remove()});
function resize(){$(".slide").each(function(){var i,e=$(this).find(".parallax").height(),h=$(this).find("img").height();i=h<e?h:e,$(this).height(i)})}$(window).on("resize",resize),resize();
$(window).scroll(function(){scroll=$(window).scrollTop(),$(".parallax").each(function(){if($(this).offset().top<$(window).scrollTop()){var o=($(window).scrollTop()-$(this).offset().top)/2+"px";$(this).find("img").css("top",o)}else $(this).find("img").css("top","0")})});